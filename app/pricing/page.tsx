    ...
    <main>
      ...
      <section className="shell" style={{ paddingTop: 56, paddingBottom: 26 }}>
        ...
        <p className="sub" style={{ maxWidth: 880 }}>
          Planit pricing is separate from vendor spend. We use vendor pricing
          only for audit recommendations.
        </p>
      </section>
      ...
      >
        <article className="card">
          ...
          <p className="sub" style={{ fontSize: 15 }}>
            Run audit, see savings, and get a basic report.
          </p>
        ...
        <article
          ...
          style={{
            borderColor: "#4b5b1d",
            background:
              "linear-gradient(180deg, rgba(201,246,0,0.08), #121510)"
          }}
        >
          ...
          <p className="sub" style={{ fontSize: 15 }}>
            Full optimization plan with Credex advisory support.
          </p>
        ...
        <article className="card">
          ...
          <p className="sub" style={{ fontSize: 15 }}>
            Compliance-heavy procurement optimization for multi-team orgs.
          </p>
      ...
      >
        ...
        >
          Find savings first, then decide whether you need advisory
          or enterprise procurement support.
        </p>
